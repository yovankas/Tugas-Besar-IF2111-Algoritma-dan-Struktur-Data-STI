...
int main()
{
    ...
    printf(".--.      .--.   ____       ____     __   ____    ,---.   .--.  .-_'''-.           .--.      .--.   ____    ,---.  ,---.   .-''-.   \n");
    printf("|  |_     |  | .'  __ `.    \\   \\   /  /.'  __ `. |    \\  |  | '_( )_   \\          |  |_     |  | .'  __ `. |   /  |   | .'_ _   \\  \n");
    printf("| _( )_   |  |/   '  \\  \\    \\  _. /  '/   '  \\  \\|  ,  \\ |  ||(_ o _)|  '         | _( )_   |  |/   '  \\  \\|  |   |  .'/ ( ` )   ' \n");
    printf("|(_ o _)  |  ||___|  /  |     _( )_ .' |___|  /  ||  |\\_ \\|  |. (_,_)/___|         |(_ o _)  |  ||___|  /  ||  | _ |  |. (_ o _)  | \n");
    printf("| (_,_) \\ |  |   _.-`   | ___(_ o _)'     _.-`   ||  _( )_\\  ||  |  .-----.        | (_,_) \\ |  |   _.-`   ||  _( )_  ||  (_,_)___| \n");
    printf("|  |/    \\|  |.'   _    ||   |(_,_)'   .'   _    || (_ o _)  |'  \\  '-   .'        |  |/    \\|  |.'   _    |\\ (_ o._) /'  \\   .---. \n");
    printf("|  '  /\\  `  ||  _( )_  ||   `-'  /    |  _( )_  ||  (_,_)\\  | \\  `-'`   |         |  '  /\\  `  ||  _( )_  | \\ (_,_) /  \\  `-'    / \n");
    printf("|    /  \\    |\\ (_ o _) / \\      /     \\ (_ o _) /|  |    |  |  \\        /         |    /  \\    |\\ (_ o _) /  \\     /    \\       /  \n");
    printf("`---'    `---` '.(_,_).'   `-..-'       '.(_,_).' '--'    '--'   `'-...-'          `---'    `---` '.(_,_).'    `---`      `'-..-'   \n\n");
    ...
    while (!isInputValid)
    {
        ...
        else if (strCompare(commandchar, "LOAD") == 0)
        {
            ...
            {
                printf("Nama file tidak valid. WayangWave tidak berhasil dijalankan.\n");
            }
        }
    ...
    while (!isQuit)
    {
        ...
        {
            songNext(&Q, &currentSong, &nextSong, &history, &currentPlaylist);
        }
        ...
        {
            quit (&arrPenyanyi, &albumPenyanyi, &laguAlbum, &currentSong, &Q, &history, &manager, &listPL);
            isQuit = true;
        }
